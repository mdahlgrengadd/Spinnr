...
Package.on_use(function (api) {
    ...
    //Sc custom Player
    api.add_files(path.join(asset_path, 'css', 'sc-player-minimal.css'), 'client');
    ...
    // Files from https://github.com/soundcloud/soundcloud-custom-player/
    api.add_files(path.join(asset_path, 'js', 'libs', 'sc-player.js'), 'client');
    api.add_files(path.join(asset_path, 'js', 'libs', 'soundcloud.player.api.js'), 'client');
